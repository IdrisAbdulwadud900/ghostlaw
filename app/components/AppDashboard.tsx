                  ...
                  <div className="letter-preview">
                    <div className="flex items-center justify-between px-5 py-3" style={{ background: "var(--surface2)", borderBottom: "1px solid var(--border)" }}>
                      ...
                      <div className="flex gap-2">
                        ...
                        <button onClick={() => downloadText(complaintResult.complaint_text as string, `GhostLaw_Complaint_${complaintAgency.toUpperCase()}_${new Date().toISOString().slice(0, 10)}.txt`)} className="btn-sm">Download</button>
                      </div>
                    </div>
